...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    #[ORM\OneToMany(targetEntity: OrganizationMember::class, mappedBy: 'user', cascade: ['remove'])]
    private Collection $organizationMemberships;

    #[ORM\OneToMany(targetEntity: ProjectMember::class, mappedBy: 'user', cascade: ['remove'])]
